...
public final class LoginActivityHandler extends Handler {
    ...
    public LoginActivityHandler(LoginActivity activity, Vector<BarcodeFormat> decodeFormats,
                                  String characterSet) {
        this.activity = activity;
        decodeThread = new LoginDecodeThread(activity, decodeFormats, characterSet,
