...
import net.dot.com.cpisa.newzxing.decoding.NewCaptureActivityHandler;
import net.dot.com.cpisa.newzxing.decoding.NewInactivityTimer;
import net.dot.com.cpisa.newzxing.view.NewViewfinderView;
...
public class MipcaActivityCapture extends BaseActivity implements SurfaceHolder.Callback {
    ...
    private NewInactivityTimer inactivityTimer;
    ...
    private TextView nlatitudeTextView, resultTextView;
    ...
    private void initView() {
        ...
        NewCameraManager.init(getApplication());
        setTitle("扫一扫");

        viewfinderView = (NewViewfinderView) findViewById(R.id.viewfinder_view);
        nlatitudeTextView = (TextView) findViewById(R.id.nlatitudeTextView);
        resultTextView = (TextView) findViewById(R.id.resultTextView);

        hasSurface = false;
        inactivityTimer = new NewInactivityTimer(this);
    ...
    protected void onPause() {
        ...
        NewCameraManager.get().closeDriver();
    }
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        try {
            NewCameraManager.get().openDriver(surfaceHolder);
        ...
        if (handler == null) {
            handler = new NewCaptureActivityHandler(this, decodeFormats, characterSet);
        }
    }
